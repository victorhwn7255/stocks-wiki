---
type: theme
tickers: [TSM, NVDA, LITE, COHR, AEHR, ONTO, AAOI, MRVL, AVGO, AXTI, VECO, ALAB, GLW, FN, VRT, CEG, CSCO, ENS, MSFT, GOOGL, AMZN, META, ORCL]
...
- [[hyperscaler-capex]] — the dedicated PAYER/SPENDER tracker; draws this page's five hyperscaler-capex subsections ([[MSFT]] + [[GOOGL]] + [[AMZN]] + [[META]] + [[ORCL]]) into one side-by-side comparison + the ~$640-720B aggregate + the cross-cutting capex dynamics. Boundary: this page = the broad demand-durability thesis (supply-side convergence + demand signals); the tracker = the focused payer-side comparison.
