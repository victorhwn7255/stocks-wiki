...
**Primary-source ingest candidates:** **[[MSFT]]** (✓ ingested S112, hyperscaler / CAPEX-flow anchor) and **[[NOW]]** (✓ ingested S113, first pure application-layer / SaaS page) — both scorecard verdicts held at primary. The remaining scorecard names await primary-source confirmation.
