---
type: theme
tickers: [NVDA, MP, HARMONIC, SANHUA, TUOPU, HENGLI, ZHAOWEI, SHUANGHUAN, ZHONGDA, SLING, NOVT, VPG, OUST, TDY, ARM, QCOM]
...
- **2026-07-08 ([[QCOM]] first-canonical ingest):** Closed the flagged edge-inference-silicon coverage gap at Layer 2 — Qualcomm is now vault-covered (the edge-inference counterpoint: Snapdragon/Oryon + Dragonwing IQ10 robotics [700 TOPS] + Figure AI / NEURA design wins); Tesla/Google/Huawei remain the uncovered challengers. +QCOM to `tickers`. last_updated 2026-06-15 → 2026-07-08.
