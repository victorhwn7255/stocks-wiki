---
type: theme
tickers: [TSM, NVDA, TSEM, XFAB, CSCO, INTC]
...
**Intel Q2 2026 primary read ([[INTC]] Q2 2026 10-Q + call, Jul 23 2026 — Tier 1/2; the first *primary* Intel-foundry datapoint this page carries).** Execution improved on both sides of the tension: **18A / Intel-3 / Intel-7 all exceeded internal volume targets**, 18A yields "ahead of expectations" with cost-per-unit down ~50% YTD, **18A-P began risk production**, and **14A PDK 0.9 is on track for October 2026** — the external-customer-decision milestone. Intel also **raised capex** (2026 gross >$20B; 2027 "significantly above") on demand-signals + tight supply. *But the external-traction gap that keeps the disconfirming signal untripped is unchanged:* Intel Foundry lost **$(2.1)B** in the quarter on only **~$293M external revenue** (up from Q1's $174M but still ~1.8% of revenue), and **no external customer was named** ("signals + long-term agreements," not booked orders). So the Q2 primary *corroborates* the Tier-3 read — Intel is executing and investing, but the "credible-but-multi-year challenger, external proof still pending" verdict holds; **the "TSMC packaging advantage narrows" disconfirming signal is NOT tripped.** (Separately, Intel's Q2 also *primary-confirms the substrate/advanced-packaging supply constraint* — EMIB-T backlogs "very high"; substrates + T-glass named a "choke point" — a demand-tightness datapoint, not a share-shift; cross-ref [[pcb-interconnect-substrate-chokepoint]].)
...
|------|--------|--------|-----------|
| 2026-07-23 | [[INTC]] Q2 2026 10-Q + call | 18A/Intel-3/7 exceeded internal targets; 18A-P risk production; 14A PDK 0.9 on track Oct 2026; capex RAISED — BUT Foundry loss $(2.1)B on ~$293M external / no named customer | Corroborates Tier-3 read — executing + investing, external proof still pending; disconfirming signal NOT tripped |
...
- **2026-07-28 (S192 — [[INTC]] Q2 2026 refresh propagation):** Added the first *primary* Intel-foundry datapoint (Q2 2026 10-Q + call): 18A/Intel-3/7 exceeded internal targets, 18A-P risk production, 14A PDK 0.9 on track for October, capex raised — but Foundry still $(2.1)B loss on ~$293M external revenue / no named customer. Q2 primary **corroborates** the Tier-3 "very distant from TSMC" read; the "packaging advantage narrows" disconfirming signal stays **untripped**. Added an evidence-tracker row; added [[INTC]] to tickers per §3.2(b). `last_updated` → 2026-07-28.
