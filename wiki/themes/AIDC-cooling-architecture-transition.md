...
| [[FLEX]] | **CPI (Cloud and Power Infrastructure) segment spin-off announced + EP² acquisition** | May 5, 2026 (completion ~Q1 CY2027) | Spin the data-center power+cooling+cloud-compute segment into a pure-play "grid-to-chip" AIDC infrastructure company (SpinCo); CPI $6,614M / 24% of FY2026 net sales (+38%, 9.2% margin); CEO Advaithi → SpinCo, Hartung → Flex; **energy_power_tier 5 → 3**. **2nd cooling/infra pure-play spin in-window alongside [[MOD]] Performance Technologies** |
...
| [[MOD]] | **Performance Technologies SPIN-OFF + Gentherm combination (Reverse Morris Trust)** | Announced Q3 FY2026; definitive agreements Jan 2026; **close end CY2026** (S-4 + shareholder vote + IRS determination done) | Pivot to data center cooling pure-play (post-spin MOD = Climate Solutions, splitting FY2027 into Data Centers + Commercial HVAC segments); $1B PT valuation + $210M cash + 40% combined ownership; FY2026 DC +158% Q4 + >$4B single-customer agreement (CY2027-2029). **Parallel to [[FLEX]] CPI spin** |
...
- **2026-05-29 (MOD FY2026 refresh propagation):** Updated the [[MOD]] Performance Technologies spin-off row — now a Reverse Morris Trust with Gentherm (definitive agreements Jan 2026; close end CY2026; S-4 + shareholder vote + IRS determination done) → pure-play (Climate Solutions splitting FY2027 into Data Centers + Commercial HVAC); FY2026 DC +158% Q4 + >$4B single-customer agreement. Now **2 confirmed parallel cooling/infra pure-play spins** (MOD PT + [[FLEX]] CPI). last_updated already 2026-05-29 (same-day FLEX refresh).
- **2026-05-29 (FLEX FY2026 refresh propagation):** Added a [[FLEX]] **CPI segment spin-off** row to the cross-vault strategic-transformation-cadence table (May 5, 2026; SpinCo grid-to-chip AIDC pure-play, Q1 CY2027; CPI $6,614M/24%, +38%, 9.2% margin; CEO Advaithi → SpinCo, Hartung → Flex; energy_power_tier 5 → 3) — now a **2nd cooling/infra pure-play spin in-window alongside [[MOD]] Performance Technologies**, reinforcing the parallel-transformation pattern. last_updated 2026-05-26 → 2026-05-29.
