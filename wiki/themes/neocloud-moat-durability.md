...
6. **Core Scientific deal status (NEW, §4.3 contradiction)** — the 2026-06-29 research reports the $9B/~1.3GW Core Scientific acquisition "closed Q4 2025," while [[CRWV]]/[[CORZ]] record CORZ stockholders *rejecting* the merger in Oct 2025. Resolve at the next CRWV/CORZ refresh; do not overwrite either page until reconciled.

## Source audit notes

- **2026-06-29 refresh (2nd Tier-3 anchor).** Added `raw/research/interactive/2026-06-29_neocloud-moat-durability-crwv-vs-nbis.md` (15-angle research-loop + a filing-grade Nebius Q1 2026 6-K dig). It **confirmed** the verdict and **closed the Nebius inferential gap**. Three contradictions flagged (resolve, don't overwrite, §4.3): (a) **Core Scientific deal status** (research "closed Q4 2025" vs [[CRWV]] "rejected Oct 2025"); (b) **NVIDIA→Nebius instrument** ("$2B + warrant" → corrected to **$2B equity**, line-item pending the 20-F); (c) **Meta take-or-pay** ~$14.2B → **≥$19B**. Honest-verdict correction: the prior "Nebius less concentrated" cell is **falsified** — Nebius is equally/more concentrated (MSFT+Meta >90% of backlog); its edge is the balance sheet. The ~$6.3B NVIDIA→CRWV backstop is flagged **[T3, unverified-vs-primary]** pending the CRWV 8-K.
