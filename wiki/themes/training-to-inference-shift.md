...
5. **The [[QCOM]] / edge counterpoint-ingest decision.** Edge is the fails-to-monetize cohort → a QCOM ingest would be a weak-fit counterpoint page (the [[INOD]] / [[PLAB]] pattern), not a strong-thesis one. Decision deferred; recorded so the effort is scoped honestly if the counterpoint is wanted on record.
