...
- **Last moved:** 2026-06-19 ([[TAIYO]] ingested S170 — the 2nd MLCC maker double-confirms the boom-but-no-hike read: "no signs of industry-wide price increases yet," prices still falling; [[MLCC-oligopoly]] promoted theme → canonical chokepoint. Prior S169: [[MURATA]] actuals landed. The cycle-clock read still pends the contract-price rollover).
