...
- **Catalyst / timeline:** MU Q3 FY2026 (~June 25, 2026) pricing/bit-growth language; **[[MURATA]] full-year actuals now IN** (S169: server-capacitor +85-90% confirmed, data-center line broke out — the MLCC half of this entry is primary-grounded); TrendForce Q3-Q4 2026 contract-price trajectory — contract following spot down is the clock striking.
...
- **Last moved:** 2026-06-19 ([[MURATA]] ingested S169 — the Murata-actuals catalyst landed: server-capacitor +85-90% confirmed, data-center line broke out; the cycle-clock read still pends the contract-price rollover).
