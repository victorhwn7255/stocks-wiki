...
**Layer 2 designation** per Caveat #7: HBM oligopoly participants sit at Layer 2 (irreplaceable infrastructure) due to three-supplier oligopoly with structural pricing power, capital intensity, and process complexity. SK Hynix / Samsung / Micron operate as canonical Layer 2 examples. Clean Layer 2; no Layer 1-2 hybrid concern.

**Per-domain Outside Framework placement scope:**
- F5 photonics outside: memory producer not photonics-direct
- F7 energy/power outside: power consumer not producer
- F8 equipment outside: memory producer not equipment supplier (derivative scope per Section 3.2(c) — MU consumes ASML EUV but does not assign equipment_tier)
- F9 materials outside: memory producer not materials supplier (derivative scope — MU consumes silicon wafers but does not assign materials_tier)

**FIRST INSTANCE framing:** first memory-domain canonical in vault. Memory framework coverage gap closure per [[HBM-oligopoly]] S64 chokepoint page anticipation ("future MU canonical creation would substantively strengthen this synthesis via Pathway 1 → Pathway 2 promotion analog OR substantive refresh propagation"). Per Section 3.15 Pathway 2 4-canonical strengthening (codified S86) — memory-domain canonical count = 1 post-S87; future Pathway 2 application track at 3+ memory canonical accumulation (memory-domain theme creation candidate).

## Company structure

**4-segment business unit framework (REORGANIZED Q4 FY2025; Section 2.1 6th instance precedent):**

| Business Unit | FY2025 Revenue | FY2025 % | Scope |
|---|---|---|---|
| **Cloud Memory Business Unit (CMBU)** | $13,524M | 36% | Memory solutions for large hyperscale cloud customers; HBM for all data center customers |
| **Core Data Center Business Unit (CDBU)** | $7,229M | 19% | Memory solutions for mid-tier cloud + enterprise + OEM data center; storage for all data center |
| **Mobile and Client Business Unit (MCBU)** | $11,859M | 32% | Memory + storage for mobile + client segments |
| **Automotive and Embedded Business Unit (AEBU)** | $4,753M | 13% | Memory + storage for automotive + industrial + consumer segments |

**Section 2.1 mid-fiscal-year disclosure methodology shift pattern 6TH INSTANCE precedent.** FY2025 10-K (Aug 28, 2025) discloses: "In the fourth quarter of 2025, we reorganized our business units. All prior-period segment amounts have been retrospectively adjusted to reflect this reorganization." Strengthens 5-instance precedent codified S86 (NVT + MOD + NOK + AMD + NVDA → +MU = 6). Differentiated from [[NVDA]] S81 venue-asymmetric sub-pattern: MU's segment shift applied uniformly across SEC 10-K + 10-Q + earnings deliverable scope (NO venue-asymmetry detected; differs from NVDA's NEW Hyperscale + ACIE + Edge Computing at earnings + investor website with SEC 10-Q preserving prior framework).

**HBM-vs-NAND business duality honest framing.** MU operates both HBM (binding 2026 chokepoint participant per `_thesis.md` Rank 1 Memory; Framework 6 Tier 2) AND NAND (cyclical commodity; non-chokepoint scope). FY2025 DRAM revenue ~75% of total ($28B+ implied); NAND ~25%. AI exposure concentrated in DRAM (HBM + LP DRAM + DDR5 server) within CMBU + CDBU. NAND business growing rapidly via data center SSD demand (G9 NAND PCIe Gen6 + 122TB high-capacity SSD) but distinct from HBM oligopoly position. Thesis-central scope = HBM oligopoly participation; NAND = adjacent revenue.

## Financial snapshot

### FY2025 annual (10-K, fiscal year ended August 28, 2025)

| Metric | FY2025 | FY2024 | FY2023 | YoY change |
|---|---|---|---|---|
| Total revenue | $37,378M | $25,111M | $15,540M | +49% |
| Net income (loss) | $8,539M (23% margin) | $778M (3%) | $(5,833M) (-38%) | +$7,761M YoY |
| DRAM revenue | ~$28,033M (~75% of total) | — | — | +62% (ASP +low-40s range; bits +mid-teens %) |
| NAND revenue | ~$9,345M (~25% of total) | — | — | — |
...
| Metric | Q2 FY2026 | Q1 FY2026 | Q2 FY2025 | QoQ | YoY |
|---|---|---|---|---|---|
| Total revenue | $23,860M | $13,643M | $8,053M | +75% | +196% |
| DRAM revenue | $18,800M (79%) | — | — | +74% | +207% |
| NAND revenue | $5,000M (21%) | — | — | +82% | +169% |
| GAAP gross margin | 75% | 57% (implied) | ~37% (implied) | +18 ppts | ~doubled |
| Operating income | $16,500M | — | — | +22 ppts margin | +44 ppts margin |
| Operating margin | 69.0% | — | — | +22 ppts | +44 ppts |
| GAAP net income | $13,785M (Q2) / $19,025M (H1) | $1,583M (impl Q1) | $1,583M (impl Q2) | — | +771% |
| Non-GAAP EPS diluted | $12.20 | $4.78 (implied) | $1.56 (implied) | +155% | +682% |
| Operating cash flow | $11,900M | — | — | — | — |
| Capital expenditures | $5,000M | — | — | — | — |
| Free cash flow | $6,900M (record) | $3,890M (implied) | — | +77% | — |
| Cash + investments | $16,700M | — | — | — | — |
| Total debt | $10,100M | — | — | -$1,600M | — |
| Net cash | $6,500M | — | — | — | — |
| Inventory (days) | $8,300M (123 days) | — | — | +$62M | — |

**Q2 FY2026 segment revenue (NEW 4-segment framework):**

| Segment | Q2 FY2026 | % | Q1 FY2026 | Q2 FY2025 | QoQ | Gross margin Q2 |
|---|---|---|---|---|---|---|
| CMBU | $7,749M | 32% | $5,284M | $2,947M | +47% | 74% |
| CDBU | $5,687M | 24% | $2,379M | $1,830M | +139% | 74% |
| MCBU | $7,711M | 32% | $4,255M | $2,236M | +81% | 79% |
| AEBU | $2,708M | 11% | $1,720M | $1,034M | +57% | 68% |
...
**HBM3E generation:** Q4 FY2025 HBM3E 12-high represented majority of HBM shipments per FY2025 10-K. Enhanced version delivers faster data rates, improved thermal response, higher monolithic die density within same package footprint.

**HBM4 36GB 12-high:** Volume shipments started Q1 calendar 2026 — **designed for NVIDIA Vera Rubin** (per Q2 FY2026 prepared remarks; NVIDIA named at Tier 2 earnings deliverable). FY2025 10-K Tier 1 disclosure: "delivered samples of HBM4 36GB 12-high to multiple key customers to power next-generation AI platforms" (customer NOT named at Tier 1 SEC filing). Production ramp + volume shipments underway; expected to reach mature yields faster than HBM3E.

**HBM4 16-high:** Sampled Q2 FY2026 — 48GB per HBM cube (33% capacity increase vs HBM4 12H).

**HBM4E next-generation:** Volume ramp expected calendar 2027 on 1γ DRAM technology node. Customization options for AI compute platform differentiation per Mehrotra Q2 FY2026 prepared remarks.

**Technology nodes:**
- 1γ (1-gamma) DRAM — highest-volume node in MU history; fastest ramp to mature yields; on track for majority of DRAM bit mix by mid-calendar 2026
- 1δ (1-delta) DRAM — increased EUV adoption planned with latest-generation EUV tools
- G9 NAND — on track for majority of bits by mid-calendar 2026; record QLC (quad-level cell) bits mix Q2 FY2026

**LP DRAM for data center (Micron-pioneered):** 256GB LP SOCAMM2 product (1γ node) enabling 2TB per CPU — quadrupled content from prior year. **NVIDIA Groq 3 LPX** (GTC March 2026 announcement) implements up to 12TB DDR5 in rack scale architecture (NVIDIA named at Tier 2 prepared remarks).

**Manufacturing footprint expansion:**
- **Tongluo (Taiwan) site:** Acquisition from Powerchip Semiconductor closed Q2 FY2026 — meaningful product shipments from existing fab fiscal 2028; plan to begin construction of second cleanroom by end FY2026
- **Idaho fab 1:** initial wafer output mid-calendar 2027
- **Idaho fab 2:** ground preparation started
- **New York fab:** ground broken; preparation activities ahead of plan
- **Hiroshima (Japan) site:** cleanroom expansion progressing
- **Singapore NAND fab:** ground broken; initial wafer output 2H calendar 2028
- **India assembly/test facility:** commercial shipments commenced — among largest single-floor assembly + test cleanrooms globally
- **Singapore advanced packaging facility for HBM:** meaningful contribution to HBM supply calendar 2027

## Customer concentration + venue-asymmetric NVIDIA disclosure

**Tier 1 SEC filing disclosure (10-K + 10-Q):** "approximately one-half of our total revenue was from our top ten customers" (FY2025 10-K + Q2 FY2026 10-Q identical framing). End-market concentration: "approximately one-half of our total revenue was concentrated in the data center end market" (Q2 FY2026 10-Q). XBRL tags show "UndisclosedCustomerMember" concentration tagging — customer names not disclosed at SEC filing scope.

**Tier 2 earnings deliverable disclosure (Q2 FY2026 prepared remarks):** NVIDIA NAMED multiple times per Mehrotra:
- NVIDIA Vera Rubin — designed-for HBM4 36GB 12H customer (Q1 calendar 2026 volume shipments started)
- NVIDIA Groq 3 LPX — GTC announcement implementing up to 12TB DDR5 (LP DRAM scope)
- NVIDIA DGX Spark + AMD Ryzen AI Halo — personal AI workstations using LPDDR5X 128GB configurations

**Section 3.6 cross-venue disclosure gap convention application (codified S86; falsification condition).** MU exhibits venue-specific NVIDIA disclosure pattern — Tier 1 SEC filings (10-K + 10-Q) preserve customer non-naming + concentration-only framing; Tier 2 earnings deliverable names NVIDIA + AMD at platform-specific scope. Per Section 3.6 honest framing: silence at SEC filing venue ≠ retreat; the earnings call is the durable disclosure venue for customer naming. Falsification condition: if earnings deliverable starts preserving NVIDIA non-naming at future cycles, pattern transitions from venue-specific silence to genuine retreat. **MU = 6th cross-venue disclosure gap convention reference post-S86 codification** (joins [[NVDA]] S81 + [[NVDA-platform-integration]] S82 + [[cpo-integration]] S84 + [[CPO-platform-battle]] S84 + [[advanced-optical-packaging]] S85b).

**Cross-canonical NVIDIA bilateral mode taxonomy — Mode 1 partial reciprocal-confirmation REFERENCE (per Vic Decision #7):** MU names NVIDIA at Tier 2 (Vera Rubin + Groq 3 LPX); [[NVDA]] Q1 FY2027 (S81 ingest) preserved supply chain non-naming pattern — MU not reciprocally named at NVDA primary substantiation. Asymmetric reciprocal naming pattern reinforces Mode 1 at 4th canonical (ARM + AMD + INTC + MU). Cross-canonical NVIDIA bilateral mode taxonomy occurrence count: 2 home + 4 reference post-S87 (was 2 home + 3 reference post-S85b). Mode 1 reinforced at 4th canonical; not a new mode per Vic Decision #7 — preserve "substantive home + reference" split count.
...
**AI demand framing (Q2 FY2026 prepared remarks, Mehrotra):**
- DRAM and NAND data center bit TAM exceeding **50% of industry TAM for first time calendar 2026**
- Server units low-teens % growth calendar 2026 (AI + traditional server combination)
- Industry DRAM bits +low-20s% calendar 2026; NAND bits ~20%
...
**Cleanroom-constraint observation (Mehrotra):** Industry DRAM bit shipments calendar 2026 +low-20s% percentage range constrained by "cleanroom constraints + long construction lead times + higher HBM trade ratio + higher HBM growth rates + declining bits per wafer growth from node migrations" — supply-side bit growth structurally bounded; consistent with [[HBM-oligopoly]] chokepoint framing.

## Sell-side re-rating debate (Tier 3 — market view, NOT vault canon)

*Tier-3 sell-side discovery; cited, not treated as fact, and carrying NO vault price target (describe-don't-recommend). Captured because the **valuation argument** bears directly on the cyclical-vs-structural question this page tracks (Open Question #8). Verify the projections against MU's next 10-Q / call before any canon use.*

A **Street-wide re-rating of memory** is underway (June 2026): multiple banks raised MU targets and openly questioned whether memory is still a *cyclical* stock. The most aggressive is **Aletheia Capital** (Warren Lau / Stefan Chang; "How Much (Memory) is Truly Enough?", Buy) — and the analytically interesting move is the **valuation-framework shift from peak price-to-book (~$650 implied) to 10× CY2027 P/E (target $1,600)**. The justification is the same argument the primary record raises: **multi-year LTAs / SCAs make memory earnings predictable and durable — "real earnings," not a boom-bust spike** — so memory should earn a normal P/E rather than a trough/peak book multiple. (Cross-ref the **first 5-year SCA signed Q2 FY2026** above + management's "memory recast as a defining strategic asset" framing.)

Tier-3 projections in the report (**to verify, not facts**): memory content rising to **>70% of AI-hardware BOM by 2027** (from ~45% in 2025); server DRAM ASP **+30–40% QoQ in C3Q26**, exiting 2026 ~**$26–27/GB**; **HBM ASP doubling YoY in 2027**; MU EPS **+8.5× CY27 then +1.8× CY28**; **$350–400bn FCF FY26-28E**. Same-wave bank targets: TD Cowen + RBC (~$1,200).

**Honest framing — this is the BULL POLE of the re-rating debate, not a vault view.** The crux is whether memory has stopped being cyclical. The counter-pole: the market has still been pricing memory names at a **low / single-digit multiple** (the Eisman–Rasgon interview, June 2026 — i.e., the market *not yet* believing the durability). The debate is live on both sides; the structural case lives at [[memory-shortage-winners-losers]] + [[HBM-oligopoly]], and this note records the sell-side bull pole + the open re-rating question (OQ #8). Source: screenshot `raw/research/charts/mu-pt-1600.png` + public coverage (Investing.com / StreetInsider / Stocktwits / TradingKey).

## Cross-vault adjacency

**[[HBM-oligopoly]] chokepoint integration (S64 + S65-S68 refresh propagation cycle; 373 lines).** MU canonical S87 confirms existing chokepoint framing:
- 11-21% market share (vault baseline preserved per `_thesis.md` Rank 1 Memory)
...
Q4 FY2025 segment reorganization disclosed in Item 1 Business: "In the fourth quarter of 2025, we reorganized our business units. All prior-period segment amounts have been retrospectively adjusted to reflect this reorganization." Section 2.1 mid-fiscal-year disclosure methodology shift pattern 6th instance precedent per Vic Decision #3 codified S86. Customer concentration: "approximately one-half of our total revenue was from our top ten customers" — NVIDIA NOT named at Tier 1 (Section 3.6 cross-venue disclosure gap candidate). Competitors named: Samsung + SK hynix + Kioxia + Sandisk + CXMT + YMTC.

### MU 10-Q Q2 FY2026 (Tier 1, filed March 19, 2026; fiscal quarter ended February 26, 2026)

NEW 4-segment framework (CMBU + CDBU + MCBU + AEBU) applied uniformly across Q2 FY2026 reporting + retrospectively adjusted Q1 FY2026 + Q2 FY2025 + H1 prior comparatives. NO venue-asymmetry detected — shift applied uniformly across SEC 10-K + 10-Q scope vs NVDA S81 venue-asymmetric pattern. Customer concentration framing identical to 10-K. End-market concentration NEW Q2 FY2026 framing: "approximately one-half of our total revenue was concentrated in the data center end market." NVIDIA NOT named at 10-Q.

### MU Q2 FY2026 earnings call prepared remarks (Tier 2, reported March 18, 2026; 10 pages PDF acquired post-Phase 0 escape valve per Vic Decision A(a1))

CEO Sanjay Mehrotra + CFO Mark Murphy + IR VP Satya Kumar prepared remarks. HBM4 36GB 12H Vera Rubin customer naming + NVIDIA Groq 3 LPX disclosure + NVIDIA DGX Spark / AMD Ryzen AI Halo personal AI workstation naming — venue-specific disclosure pattern at Tier 2 vs Tier 1 silence (Section 3.6 cross-venue disclosure gap convention application). First 5-year SCA signed disclosed; counterparty NOT named. Q3 FY2026 guidance: revenue $33.5B ± $750M (record exceeding full year revenue for every year through fiscal 2024). Memory "recast as defining strategic asset in AI era" framing. CEO closing: "only U.S.-based manufacturer of advanced memory products" — Framework 6 Tier 1 upgrade evidence candidate per Tranche 2C-iii observation.

### Aletheia Capital — "How Much (Memory) is Truly Enough?" (Tier 3 sell-side, June 2026; screenshot + public coverage)

Tier-3 independent sell-side research (Warren Lau + Stefan Chang, Hong Kong): **Buy**, target raised to **$1,600** (from a ~$650 peak-PBR-implied level) on a valuation-framework shift to **10× CY2027 P/E**, justified by **LTA/SCA-driven earnings durability** ("memory no longer cyclical"). Cited as a **market-sentiment / re-rating-debate datapoint — NOT primary fact and NOT a vault price target** (describe-don't-recommend). Part of a Street-wide June-2026 re-rating wave (TD Cowen, RBC ~$1,200). Its projections (DRAM/HBM ASP, content-share, EPS, FCF) are Tier-3 assertions to verify at MU's next 10-Q/call. Source materials: `raw/research/charts/mu-pt-1600.png` + public coverage (Investing.com / StreetInsider / Stocktwits / TradingKey, June 2026).
