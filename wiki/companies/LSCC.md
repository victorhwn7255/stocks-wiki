...
This is the secure-control-FPGA capability the Defense thesis prizes (NDAA-compliant secure FPGAs / hardware root of trust per `frameworks-defense-drones.md` D5). `defense_tier 4` (supply-chain enabler / chokepoint capability).
