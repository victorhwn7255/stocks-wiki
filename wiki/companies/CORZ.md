...
- **2026-06-16 (S164):** Added [[neocloud-moat-durability]] theme cross-ref (back-link) in Thesis role — the theme affirms the host tier as the more durable position (owns power-secured land vs the rental layer renting it). No financial content changed; last_updated unchanged.
