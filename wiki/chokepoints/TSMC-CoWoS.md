---
type: chokepoint
tickers: [TSM, NVDA, AEHR, ONTO, AVGO, MRVL, INTC]
...
**[[AEHR]]** explicitly names "CoWoS" as an application for its FOX-NP burn-in systems, positioning Known-Good Die (KGD) testing as economically critical for multi-die advanced packaging — a defective die in a CoWoS package wastes the entire package (AEHR Q3 FY2026 call). AEHR's FY2026 refresh sharpened the demand echo: its lead AI wafer-level customer moved *all* production burn-in and screening to wafer-level (no longer performing system-level screening), and a top-tier AI accelerator/CPU/network supplier is moving to pilot production test validation at its Taiwan contract manufacturer after a benchmark that "exceeded their expectations." Q4 FY2026 bookings reached $60.7M (+>500% YoY) and year-end backlog a record $80.6M (AEHR Q4 FY2026 call; AEHR 10-K FY2026) — advanced-packaging test demand accelerating upstream of the CoWoS integration step.
...
8. **Intel EMIB competitive evolution.** TSMC acknowledged EMIB as real alternative (Morgan Stanley Q1 2026 question) — not dismissive framing. EMIB substrate-based "more suitable for circular larger size chip design." Intel Foundry execution trajectory + EMIB customer adoption + AVGO/NVDA/MRVL dual-sourcing dynamics pre-registered for cross-vault [[foundry-competition]] theme refresh. TSMC's packaging advantage narrows disconfirming signal test candidate. **Q2 2026 datapoint ([[INTC]] 10-Q + call, Jul 23 2026):** Intel reports **EMIB-T advanced-packaging backlogs "continue to be very high"** with "very high" customer interest for AI-silicon solutions — an advanced-packaging *demand-strength* read (the whole packaging space is capacity-tight), NOT a disclosed CoWoS share-shift; Intel Foundry still $(2.1)B/qtr on ~$293M external revenue with no named external customer. **Does not trip the "packaging advantage narrows" disconfirming signal** (cross-ref [[foundry-competition]]).
...
- **2026-07-29 (S195 — [[AEHR]] FY2026 refresh; light):** Refreshed the AEHR equipment-tier demand echo — lead AI customer moved all production burn-in to wafer-level; a top-tier AI/CPU/network supplier is piloting production test at its Taiwan contract manufacturer after a beat-expectations benchmark; Q4 FY2026 bookings $60.7M (+>500%), record $80.6M backlog. last_updated 2026-07-28 → 2026-07-29.
- **2026-07-28 (S192 — [[INTC]] Q2 2026 refresh; light):** Added a Q2 2026 primary datapoint to Open Question #8 (Intel EMIB) — EMIB-T advanced-packaging backlogs "very high" = packaging demand-strength (whole space capacity-tight), NOT a disclosed CoWoS share-shift; Intel Foundry still $(2.1)B/qtr on ~$293M external / no named customer → "packaging advantage narrows" disconfirming signal NOT tripped. Added [[INTC]] to `tickers` per §3.2(b). `last_updated` 05-29→07-28.
