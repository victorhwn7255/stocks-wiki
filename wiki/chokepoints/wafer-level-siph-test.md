...
**FY2026 refresh update (Session 195, AEHR Q4 FY2026 call).** The FY2026 refresh provides the first primary evidence bearing on this page's Open Questions #1 (attach rate) and #5 (concentration trajectory), both pointing toward the *strengthen* direction. On attach rate: AEHR's lead AI wafer-level customer moved *all* production burn-in and screening to wafer-level (no longer performing system-level screening), evidence that screening is migrating upstream as packaging complexity rises. On silicon-photonics breadth specifically: AEHR now has **two** silicon-photonics customers ramping — its lead SiPh customer (fully-automated FOX with AGV handling for high-volume production) and a new "global leader in networking products and solutions" ramping hyperscale-datacenter capacity (engaged November 2025, already ordered two nine-wafer FOX cells + two FOX-NPs). Management guides silicon photonics to 15-20% of the FY2027 revenue mix and calls optical test/burn-in "a meaningful long-term growth driver," reiterating its "market leader in wafer-level burn-in for silicon photonics transceivers" claim (still unverified). Company-wide customer concentration also *eased* (top customer 26.3% of FY2026 revenue vs 67% two years earlier). **The provisional single-company-exposure status HOLDS** — the breadth is within AEHR's own customer base, not a second public pure-play entering the vault; none of the page-top expansion triggers (FormFactor, ASE/Amkor, Onto expanding into reliability test) has fired. See [[AEHR]] for primary-source detail.
...
- **2026-07-29 (Session 195 — [[AEHR]] FY2026 refresh propagation; substantive):** Added an FY2026 refresh update to AEHR positioning — silicon-photonics exposure broadened from one customer to two (lead ramping fully-automated + a new "global leader in networking products and solutions"), and Open Questions #1 (attach rate) + #5 (concentration trajectory) both gained primary evidence pointing toward the *strengthen* direction (lead AI customer moved all production burn-in to wafer-level; company-wide top-customer concentration eased 67%→26.3%; SiPh guided to 15-20% of the FY2027 mix). Provisional single-company-exposure status HELD — the breadth is within AEHR's own customer base, no second public pure-play entered, no page-top expansion trigger fired. last_updated 2026-04-28 → 2026-07-29.
