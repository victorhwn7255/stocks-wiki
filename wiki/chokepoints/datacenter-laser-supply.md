...
## EML/CW capacity-allocation tension + CPO supply-demand imbalance (S150 propagation; from the in-vault LITE Q3 FY2026 call)

**Under-extracted primary content from the S50 baseline call (May 5, 2026; transcript in vault), surfaced via a Tier-3 video lead and verified directly against the transcript.** CEO Michael Hurlston's Q3 FY2026 commentary adds a structural mechanism this page had not captured: **the EML and CW laser lines compete for the same constrained fab capacity, and the allocation tension is itself a chokepoint dynamic.**

- **EML line at maximum tension.** Record EML shipments; 200G EML revenue "more than doubled sequentially"; laser chips shipped 2× YoY; on track for ">50% growth in EML units by the December quarter of 2026"; Japan wafer fab "remains at a premium and is fully allocated" (Hurlston, LITE Q3 FY2026 call).
- **The CW allocation squeeze.** LITE delayed introducing its own CW lasers into its transceivers "just seeing so much tension on the EML line" — then the **external CW market itself tightened**: *"we've seen a little bit of tension in our own supply line, externally to get lasers from the external market, CW lasers. As such, now we've allocated more of our fab capacity to CW lasers"* — only ~20% of LITE's modules use its own CW lasers in the current guide, "still minority" (Hurlston). **Even the largest merchant laser maker partially buys CW lasers externally and has felt that supply tighten** — the structural reason CPO-grade CW/ELS demand spills to merchant challengers (see the SIVE evidence section).
- **CPO imbalance stated at maximum strength.** *"We will have a massive supply demand imbalance on CPO. It's gonna be very, very significant"*; *"our largest single growth driver, scale-up CPO, is still very much in its infancy"* (Hurlston). UHP laser ramp for CPO proceeding to plan, with a **multi-$100M purchase order slated for 1H CY2027**; scale-up CPO framed as **">$5 billion of incremental revenue" if executed**; Greensboro NC fab online **2028**.

**Implication.** The chokepoint now has a documented *intra-supplier* capacity-allocation layer: pluggable-driven EML demand and CPO-driven CW/ELS demand compete for the same InP fab capacity, so the CPO ramp tightens the laser constraint from inside the incumbents before any new demand is added. Strengthens the chokepoint dynamic; first-order watch item is LITE's own-CW mix (~20% → ?) and the 1H CY2027 PO fulfillment.
...
- **2026-06-10 (S150 — under-extracted primary propagation):** Added "EML/CW capacity-allocation tension + CPO supply-demand imbalance" section from the in-vault LITE Q3 FY2026 transcript (May 5, 2026) — Hurlston quotes the S50 refresh had not captured: EML line at max tension (record shipments; Japan fab fully allocated), the CW allocation squeeze (LITE delayed own-CW intro on EML tension, then external CW market tightened; ~20% own-CW mix), "massive supply demand imbalance on CPO," scale-up CPO "in its infancy" + >$5B incremental framing, multi-$100M UHP PO for 1H CY2027, Greensboro online 2028. Surfaced via Tier-3 video lead (2026-05-08 optical-interconnect video intel note); verified directly against the in-vault transcript before page use. New intra-supplier capacity-allocation layer documented.
