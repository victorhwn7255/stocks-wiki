...
**Q1 FY2027 update (MRVL 10-Q + May 27, 2026 call).** Celestial PPA finalized at **$3.5B** total purchase consideration and consolidated from Feb 2, 2026 (the 10-K had deferred it as "not practicable"); a $331.8M Celestial earn-out remeasurement ran through Q1 GAAP earnings — narrowing the framing gap above. Management now forecasts scale-up optics revenue next fiscal year (FY2028) to "more than double" the prior ~$150M Celestial-only outlook, with a 3rd-generation **6.4T silicon-photonics light engine** engaged with multiple Tier 1 customers for NPO/CPO and the Celestial solution "selected by 1 hyperscaler" for next-gen XPU scale-up; MRM-based scale-up progresses in close collaboration with TSMC on CoWoS. New **Polariton acquisition** (plasmonics; >1 THz modulator bandwidth, ~10× silicon photonics / TFLN) extends the coherent / DCI roadmap to 3.2T (call-disclosed; not in 10-Q). **NVDA equity at MRVL:** NVIDIA took a **$2.0B convertible-preferred stake** in Marvell (March 31, 2026) alongside a NVLink Fusion / optics / AI-RAN partnership — a second NVDA equity-plus-partnership instance at CPO scope (cf. the LITE + COHR $2B section above), documented as [[NVDA-platform-integration]] Mode 4. The Murphy bifurcation extends to a scale-out / scale-up / **scale-across** trifurcation.
