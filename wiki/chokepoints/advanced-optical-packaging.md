...
## Vertical integration pattern distinction (4 distinct patterns)

**The structurally most analytically rich cross-source synthesis at this chokepoint.** Four vault companies operate at the same chokepoint with four distinct vertical integration approaches, producing different competitive economics:

| Company | Layer | Vertical integration approach | Competitive economics |
|---|---|---|---|
| **FN** | 6 | **Pure contract manufacturing** — no in-house product/material; customer-neutral | Margin-stable; volume-driven; less idiosyncratic risk; customer relationships span vault peers (NVIDIA + Cisco + AWS emerging) |
| **LITE** | 4 | **Component supplier with internal packaging** — three-inch InP fabs + EML/transceiver assembly | Differentiated component pricing; capacity-constrained; supply-allocation negotiating leverage |
| **COHR** | 4 | **Substrate-to-system vertical integration** — six-inch InP device fabrication + EML + VCSEL + transceiver + Materials segment | Highest gross margin potential; broadest moat; structural pricing power if six-inch InP advantage holds |
...
Per honest-verdict discipline: no forced winner attribution. Four structurally distinct integration approaches preserve genuine competitive uncertainty. Each company's competitive economics depends on different externalities:
- FN succeeds if optical contract manufacturing tier captures CPO transition value (Grady "amounts relatively small right now" but trajectory positive)
- LITE succeeds if three-inch InP industry-standard remains commercially viable through 1.6T transition
- COHR succeeds if six-inch InP device-fabrication advantage translates to expansion economics + premium pricing
