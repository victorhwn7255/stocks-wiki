---
type: chokepoint
tickers: [FN, LITE, COHR, AAOI, TSEM, ANET, NOK, MKSI, NVDA, MRVL]
...
**MRVL Polariton plasmonic-modulator addition (Q1 FY2027 propagation).** MRVL's Q1 FY2027 call disclosed the acquisition of Polariton, a developer of plasmonics-based silicon-photonics modulators with demonstrated bandwidth >1 THz (characterized as ~10× silicon photonics / TFLN), extending MRVL's DCI / coherent roadmap to 3.2T and beyond. The broader silicon-photonics platform spans MZM, EAM, and MRM modulators, with a 3rd-generation 6.4T light engine engaged with multiple Tier 1 customers for NPO/CPO. Modulator-bandwidth advances are an advanced-packaging-adjacent lever — the light engine and modulators co-integrate into the optical package; call-disclosed only (not in the 10-Q). See [[MRVL]] and [[cpo-integration]].
...
- **2026-05-29 (MRVL Q1 FY2027 refresh propagation):** Added "MRVL Polariton plasmonic-modulator addition" note at CPO advanced packaging implications — Polariton acquisition (plasmonics; >1 THz modulator bandwidth, ~10× silicon photonics / TFLN; 3.2T roadmap) + MZM / EAM / MRM platform + 3rd-generation 6.4T light engine for NPO/CPO (MRVL Q1 FY2027 call; call-only, not in 10-Q). Frontmatter tickers 9 → 10 ([[MRVL]] added per Section 3.2(b) provenance). last_updated 2026-05-24 → 2026-05-29.
