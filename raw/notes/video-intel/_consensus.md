...
- **Sources (7):** Reiner Pope 04-29 ("hyperscalers ~50% of 2026 capex on memory"; inference is memory-bandwidth-bound) · nico-alpha MLCC 06-07 (GPU→memory→MLCC stack) · Eisman/Rasgon 06-08 (MU +100%) · Maverick 06-18 (long memory; "maniacal focus on the next bottleneck — memory") · Goldman macro 06-19 ("memory trading incredibly well") · invest-like-the-best 06-09 (HBM in the decommoditization list) · **BlackRock/Jewell 07-28** (Korea memory CEOs quoted **3-year order books** → earnings certainty).
...
### A9. The tape is MOMENTUM / positioning-driven, not fundamentals-driven (market-structure shift)
- **Sources (5+):** Goldman/Privorotsky 07-15 (2x-levered-ETF AUM +50% YTD, half in semis; one-way-long call skew) · Goldman/Garrett 07-17 (leveraged/inverse ETFs 1-in-3 of new issues; short-gamma amplifies single-stock vol) · Goldman/Lin 07-24 (momentum-factor vol at a 45-yr high ex-recessions; largest tech selling on a 10-yr record = risk-mgmt, not conviction) · Goldman roundtable 07-25 (same 45-yr momentum-vol stat) · **BlackRock/Jewell 07-28** (the decomposition: retail ~20–25% of US volume; 0DTE ~half of S&P options vs <5% in 2020; quant the fastest-growing HF category; holding periods down to "a few months"; the ~10–20% structural-growth premium eroding as short-term money crowds in).
- **Vault:** no single page owns "market structure," but it underpins [[forward-pe-watch]] (price-effect vs earnings-revision decomposition) + the [[macro-regime]] insight + the "momentum masks fundamentals" read behind [[AI-demand-durability]]. The convergence is *why* the vault discriminates on primary-grounded ROC rather than price action — external validation of the describe-don't-recommend / structure-over-momentum discipline. **Note:** all sources agree the tape is momentum-led; none claims to time its unwind — a *conditions* read, not a dated call.
...
| C11 | "AI capex *impulse* fades from 2027 onward — spend keeps growing but the *rate* of growth falls" (JPM economics via Jewell, rec. Apr 6) | ⏳ **PENDING** | Forward house call; the same 2027 inflection as C8 (BG2/MS $1.1–1.5T) approached from the *rate-of-change* side. Track vs the [[hyperscaler-capex]] growth rate across 2026→2027 prints + the queued Q2 hyperscaler-ROI pass. |
