...
*Version: v9.5 (Section 1.3 filename-convention invariant + `fetch_filings.py` skip-check hardening — raw/ storage made durable for two-axis growth; Session 126; 2026-06-04). Prior: v9.4 two-domain scope + Section 3.2 `defense_tier` + Section 1.3 raw/ per-ticker reorg, Session 123.*
